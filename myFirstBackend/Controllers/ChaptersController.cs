...
namespace myFirstBackend.Controllers
{
    ...
    public class ChaptersController : ControllerBase
    {
        ...
        // GET: api/Chapters
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Chapter>>> GetCahpters()
        {
            return await _context.Cahpters.ToListAsync();
        }
        ...
        {
            var chapter = await _context.Cahpters.FindAsync(id);
        ...
        public async Task<IActionResult> DeleteChapter(int id)
        {
            ...
            _context.Cahpters.Remove(chapter);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.Cahpters.Any(e => e.Id == id);
        }
    }
}
